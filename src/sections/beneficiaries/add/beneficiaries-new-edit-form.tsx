...
const BeneficiariesForm: React.FC = () => {
  ...
  const NewBeneficiarySchema = Yup.object().shape({
    ...
    gender: Yup.mixed<GENDER>().nullable().required('Select your gender'),
    phoneOwnership: Yup.string().nullable().required('Select your phone type'),
    bankStatus: Yup.string().nullable().required('Select your bank status'),
    internetAccess: Yup.string().nullable().required('Select your internet type'),
