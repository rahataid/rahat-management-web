...
const CampaignsService = {
  ...
  update: (uuid: string, data: ICampaignCreateItem) => axiosInstance.patch(endpoints.campaigns.update(uuid),{...data}),
  ...
  bulkAudiences: (data: any) => axiosInstance.post(endpoints.campaigns.bulkAudiences,{...data}),
};
